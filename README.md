...
Clone this repository on your Docker host, cd into docker-prometheus-grafana directory and run compose up:

```bash
git clone https://github.com/xtinhvl/docker-prometheus-grafana.git
